...
*-- 简体中文
	...
	*** InitHeader
	#Define ManyHeader_InitHeader_1		"当 AllowCellSelection = .F. 时，表格的 Valid 至少需要一行空指令，请随便添加一行 * 指令。"
...
*-- 羉砰いゅ
	...
	*** InitHeader
	#Define ManyHeader_InitHeader_1		"讽 AllowCellSelection = .F.  Valid ぶ惠璶︽叫繦獽睰︽ * "
...
*-- Englisth
	...
	*** InitHeader
	#Define ManyHeader_InitHeader_1		"When AllowCellSelection =. F., Grid.Valid() methods can not be empty. not add his command: *"
